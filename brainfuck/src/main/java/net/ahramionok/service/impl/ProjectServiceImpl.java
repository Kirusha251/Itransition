...
public class ProjectServiceImpl implements ProjectService {
    ...
    @Override
    public Project findByIdUser(Integer user) {
        return projectRepository.findByIdUser(user);
    }
    ...
    @Override
    public Collection<Project> findAllByIdUser(Integer user) {
        return projectRepository.findAllByIdUser(user);
    }
}
